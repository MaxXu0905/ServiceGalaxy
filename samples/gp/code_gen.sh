buildsql -d GP -h ./include -H ./src -f auto_select -c select_class -s 200 << EOF
...
buildsql -d GP -h ./include -H ./src -f auto_insert -c insert_class -s 200 << EOF
...
buildsql -d GP -h ./include -H ./src -f auto_update -c update_class -s 200 << EOF
...
buildsql -d GP -h ./include -H ./src -f auto_delete -c delete_class -s 200 << EOF
