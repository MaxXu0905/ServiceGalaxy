...
public:
    ...
    log_file(switch_mode mode_, const string& logpfx_, const string& procname_ = "");
    virtual ~log_file();

	void set_procname(const string& procname_);
	void setenv();
    void write_log(const char* filename, int linenum, const char* msg, int len = 0);
    void write_log(const char* filename, int linenum, const string& msg);
    void write_log(const string& msg);
    void write_log(const char *msg);
    void write_log(int lvl, const char* filename, int linenum, const char* msg, int len = 0);
    void write_log(int lvl, const char* filename, int linenum, const string& msg);
    void write_log(int lvl, const string& msg);
    void write_log(int lvl, const char *msg);
