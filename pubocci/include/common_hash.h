/*
*   file:   common_hash.h
*   author: Lloyd Liu @ amdocs-longshine
*   date:   2006-7
*   desc:   a class of general hashtable
*   ver:    sunshine 4.0.0
*   notice: 缺少类型检查,不安全.
*/
...
struct hash_unit_t {
    ...
    {
        throw bad_msg(__FILE__, __LINE__, 110, (_("ERROR: Can't find overrided function void get_hash_key(char* hash_key) const")).str(SGLOCALE));
    ...
    {
        throw bad_msg(__FILE__, __LINE__, 111, (_("ERROR: Can't find overrided function bool equal(const hash_unit_t* right) const")).str(SGLOCALE));
